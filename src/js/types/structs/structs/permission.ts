...
export const PermissionRecord = {
  encode(message: PermissionRecord, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PermissionRecord {
  ...
  fromJSON(object: any): PermissionRecord {
    return {
      permissionId: isSet(object.permissionId) ? String(object.permissionId) : "",
