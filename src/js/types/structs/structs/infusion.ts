...
function createBaseInfusion(): Infusion {
  return { destinationType: 0, destinationId: "", fuel: 0, power: 0, commission: "", playerId: "", address: "" };
}

export const Infusion = {
  encode(message: Infusion, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Infusion {
