...
export const StructsPacketData = {
  encode(message: StructsPacketData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): StructsPacketData {
